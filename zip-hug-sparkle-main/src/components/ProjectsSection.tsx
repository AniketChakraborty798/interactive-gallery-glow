...
import aiHireHeroCover from "@/assets/ai-hire-hero-cover.jpg";
import revcodeCover from "@/assets/revcode-cover.jpg";

const projects = [
  {
    title: "AI Hire Hero 69",
    description:
      "An AI-powered recruitment platform with separate recruiter and candidate portals. Recruiters can post jobs, manage applications, schedule interviews and evaluate candidates, while candidates discover roles, apply and take AI-assisted interviews. Includes secure authentication, an applicant tracking dashboard, automated workflows and real-time application status updates.",
    tags: ["React", "TypeScript", "Tailwind CSS", "Supabase", "AI APIs", "Vite"],
    color: "from-primary/20 to-accent/20",
    image: aiHireHeroCover,
    github: "https://github.com/AniketChakraborty798/ai-hire-hero-69",
    live: "https://ai-hire-hero-69.vercel.app/",
  },
  {
    title: "RevCode",
    description:
      "An AI-powered code review platform that gives instant, intelligent feedback on pasted or uploaded source code. It flags potential bugs and code smells, suggests performance optimizations and guides users toward clean-code best practices across multiple programming languages, with a secure submission workflow.",
    tags: ["React", "TypeScript", "Tailwind CSS", "AI API", "Supabase", "Vite"],
    color: "from-accent/20 to-primary/20",
    image: revcodeCover,
    github: "https://github.com/AniketChakraborty798/revcode",
    live: "https://revcode-seven.vercel.app/",
  },
  {
        ...
        {projects.map((project, i) => (
          ...
          >
            ...
            <div className={`h-48 bg-gradient-to-br ${project.color} relative overflow-hidden`}>
              {project.image ? (
                <img src={project.image} alt={project.title} loading="lazy" className="w-full h-full object-contain p-4" />
              ) : (
                <motion.div
